...
var InputEmpatScreen = ({navigation}) => {
  ...
  return (
    ...
    <ScrollView style={styles.container}>
      ...
      {/* untuk menampilkan input tanggal pergerakan tanah */}
      <View style={styles.containerData}>
        ...
        <View style={{marginTop: 20, paddingHorizontal: 20}}>
          ...
          <View style={{marginLeft: 30, marginBottom: 15}}>
            <Text style={{fontSize: 14, marginBottom: 5}}>Keterangan:</Text>
            <Text style={{fontSize: 14, marginBottom: 5}}>
              1. Pergerakan Tanah Tinggi
            </Text>
            <Text style={{fontSize: 14, marginBottom: 5}}>
              2. Pergerakan Tanah Sedang
            </Text>
          </View>
        </View>
        <TouchableOpacity
...
export default InputEmpatScreen;
